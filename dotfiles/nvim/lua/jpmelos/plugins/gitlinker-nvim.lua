return {
    ...
    config = function()
        ...
        vim.api.nvim_set_keymap("n", "<leader>gy", "<cmd>GetGitLink<CR>", { desc = "Copy git permalink" })
        vim.api.nvim_set_keymap("v", "<leader>gy", "<cmd>GetGitLinkV<CR>", { desc = "Copy git permalink" })
    end,
}
