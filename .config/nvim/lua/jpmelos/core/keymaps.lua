...
-- Tab navigation.
K("n", "<C-M-j>", "<cmd>tabp<CR>", { desc = "Previous tab" })
K("n", "<C-M-k>", "<cmd>tabn<CR>", { desc = "Next tab" })

-- Tab reordering.
K("n", "<C-M-u>", "<cmd>tabmove -1<CR>", { desc = "Move tab left" })
K("n", "<C-M-i>", "<cmd>tabmove +1<CR>", { desc = "Move tab right" })
