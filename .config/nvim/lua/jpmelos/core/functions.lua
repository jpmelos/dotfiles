...
function SmartPasteLink()
    ...
    -- Join multi-line selections with spaces (Markdown links cannot span
    -- multiple lines).
    ...
    -- Check if we are past the end of the line by one column in visual mode.
    local line_content =
        vim.api.nvim_buf_get_lines(0, end_line - 1, end_line, false)[1]
